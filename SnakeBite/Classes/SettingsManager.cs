...
namespace SnakeBite
{
    ...
    public class SettingsManager
    {
        ...
        internal static string vanillaDatHash = "5A6D1AD92FE08E16636A5A5498552097C8E2378B8811E96F40DDC20D75509D99"; //expected original hash for 1.0.15.4 // To generate this run snakebite and toggle mods off, then look for the latest '[UpdateDatHash] Updated 00/01 dat hash to' in the log or grab it from the snakebite.xml
